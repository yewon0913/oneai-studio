  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        ...
        {/* ═══ AI 템플릿 갤러리 (프롬프트 라이브러리 & 배치 생성 대체) ═══ */}
        <div id="templates-section">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filteredTemplates.map((template) => (
              <Card
                key={template.id}
                className="group cursor-pointer hover:border-primary/30 transition-all duration-300 bg-card border-border overflow-hidden hover:shadow-lg hover:shadow-primary/5"
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2">
                    <Badge variant="outline" className={`text-[10px] ${template.engineColor} backdrop-blur-sm`}>
                  ...
                  {template.popular && (
                    <div className="absolute top-2 right-2">
                      <Badge className="bg-orange-500/90 text-white text-[10px] gap-1">
                        <Flame className="h-2.5 w-2.5" />인기
                      </Badge>
                    </div>
                  )}
                  ...
                  <div className="absolute inset-0 bg-primary/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <div className="bg-white/90 dark:bg-black/80 rounded-full p-3 shadow-xl">
