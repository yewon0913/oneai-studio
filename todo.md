...
## v3.41 커플 합성 탭 AI 정밀이미지분석 기능 추가
- [x] tRPC 엔드포인트 생성 - couple.analyzeImage (beauty-analyzer 활용)
- [x] ProjectWorkspace 커플 탭에 "🔍 AI 정밀이미지분석" 버튼 추가
- [x] 분석 결과 표시 UI 추가 (피부토, 조명, 배경, 메이크업 등)
- [x] 분석 결과를 메인 프롬프트에 자동 반영
- [x] 분석 로드 중 상태 표시
- [x] TypeScript 에러 0개 확인
- [x] 브라우저 테스트 완료
